...
export const dbData = {
  courses: [
      ...
      lessons: [
        {
          ...
          longDescription:
            'This is step by step guide to create your first Angular application. Its aimed at beginners just starting out with the framework.This lesson will show how to create a component, and how to link the component to a given custom HTML tag. It will show how to give the component a given template.'
        },
        {
        ...
        },
        {
          ...
          longDescription:
            'In this lesson we are going to learn how to use the Angular template syntax for properties, and learn how we can use it to pass input data to a component. We are going to see also a simplified input syntax for passing constant strings as component inputs.'
        },
        {
          url: 'angular2-component-events',
          description:
            'Angular Component Events - Using @Output to create custom events',
          duration: '4:44',
          tags: 'BEGINNER',
        ...
        },
        {
          ...
          pro: true,
          longDescription:
            'In this lesson we are going to learn how components can be styled using both inline styles and an external css file. We will learn some more best practices on file naming. We will learn how the mechanism for style isolation works in Angular.'
        },
        {
        ...
        },
        {
          ...
          description:
            'Angular Directives - Inputs, Output Event Emitters and How To Export Template References',
          duration: '4:01',
          tags: 'BEGINNER',
          pro: true,
          longDescription:
        ...
        },
        {
          ...
          pro: true,
          longDescription:
            'This lesson is an extended tour on Angular directives. This is an extremely powerful feature of Angular that often remains underused. Its super powerful and and if used correctly can be used to create functionality that is much more reusable than components themselves.'
        },
        {
          description:
            'Introduction to Angular Directives - Exercise - Improve the Collapsible Directive',
          duration: '1:30',
        ...
        },
        {
          ...
          duration: '2:40',
          url:
            'angular2-directives-exercise-solution-improve-collapsible-directive',
          tags: 'BEGINNER',
          pro: true,
          longDescription:
    ...
    },
    {
      ...
      longDescription:
        "<p class='course-description'>Build Services using Observables, learn to use the HTTP module effectively.",
      iconUrl:
        'https://angular-academy.s3.amazonaws.com/thumbnails/services-and-http.jpg',
      courseListIcon:
      ...
      lessons: [
        ...
        },
        {
          ...
          duration: '5:28',
          url:
            'angular2-observables-error-handling-and-completion-network-calls-as-observables',
          tags: 'BEGINNER',
        ...
        {
          description:
            'How does Angular HTTP use Observables ? The HTTP Response object',
          duration: '4:32',
        ...
        },
        {
          ...
          duration: '4:32',
          url:
            'angular2-how-to-use-observables-and-http-to-build-a-servicelayer',
          tags: 'BEGINNER',
          videoUrl: '',
          longDescription:
            'In this lesson we are going to learn how to use Angular HTTP to build the service layer of our application. We are going to learn how to build strongly typed services and we are going to learn how the service layer can be designed around the notion of Observables.'
        },
        {
          description:
            'Introduction to Functional Reactive Programming - Using the Async Pipe - Pitfalls to Avoid',
          duration: '4:36',
          url:
            'angular2-how-to-use-the-async-pipe-to-pass-observables-into-a-template',
          tags: 'BEGINNER',
          pro: true,
          longDescription:
        ...
        },
        {
          ...
          duration: '3:04',
          url:
            'angular2-observable-map-operator-how-to-create-an-observable-from-another',
          tags: 'BEGINNER',
          pro: true,
          longDescription:
        ...
        {
          description:
            'Avoid the Biggest Pitfall of Angular HTTP - Learn the RxJs Cache Operator',
          duration: '5:10',
          url:
            'angular2-how-to--aAvoid-duplicate-http-requests-rxjs-cache-operator',
          tags: 'INTERMEDIATE',
          pro: true,
          longDescription:
        ...
        },
        {
          ...
          duration: '4:19',
          url:
            'angular2-how-to-do-multiple-http-requests-using-the-rxjs-concat-operator',
          tags: 'INTERMEDIATE',
          pro: true,
          longDescription:
        ...
        },
        {
          ...
          duration: '3:58',
          url:
            'angular2-how-to-do-two-http-requests-in-parallel-using-the-rxjs-combinelatest-operator',
          tags: 'INTERMEDIATE',
          pro: true,
          longDescription:
        ...
        },
        {
          ...
          duration: '4:33',
          url:
            'angular2-how-to-setup-an-http-request-sequence-using-the-rxjs-switchmap-operator',
          tags: 'INTERMEDIATE',
          pro: true,
          longDescription:
        ...
        },
        {
          ...
          duration: '3:42',
          url:
            'angular2-retry-http-requests-in-error-using-the-retry-and-retrywhen-rxjs-operators',
          tags: 'INTERMEDIATE',
          pro: true,
          longDescription:
        ...
        },
        {
          ...
          duration: '2:56',
          url:
            'angular2-how-to-cancel-an-http-request-using-an-rxjs-subscription',
          tags: 'INTERMEDIATE',
          pro: true,
          longDescription:
        ...
        },
        {
          ...
          duration: '3:15',
          url:
            'angular2-exercise-improve-a-search-service-and-build-a-typeahead',
          tags: 'INTERMEDIATE',
          pro: true,
          longDescription:
        ...
        },
        {
          ...
          duration: '5:07',
          url:
            'angular2-exercise-solution-learn-how-to-build-a-typeahead-that-cancels-obsolete-search-requests',
          tags: 'INTERMEDIATE',
          pro: true,
          longDescription:
            'This is the solution for the HTTP and Services exercise, where we will build a Typeahead. For that we are going to use a couple of RxJs Operators that we have previously presented in this course. We are going to see how results from a previous search can be implicitly canceled.'
        }
      ]
    }
  ]
